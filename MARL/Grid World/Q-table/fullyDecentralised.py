...
plt.show()
# save q_table
with open(f"fixed-start-q1-{int(time.time())}.pickle", "wb") as f:
     pickle.dump(q_table1,f)
with open(f"fixed-start-q2-{int(time.time())}.pickle", "wb") as f:
     pickle.dump(q_table2,f)
with open(f"fixed-start-q3-{int(time.time())}.pickle", "wb") as f:
